...
Балансировщик не должен становиться точкой отказа, он должен быть развёрнут на нескольких узлах.

При георезервировании возникает вопрос маршрутизации трафика за пределами одной площадки. Для решения этой проблемы максимально эффективным инструментом считается GSLB (Global Server Load Balancer).
